...
for ( let i = 0; i < headerFour.length; i++ ) {
  headerFour[i].style["color"] = "blue";
  headerFour[i].style["font-size"] = "30px";
  headerFour[i].style["font-weight"] = "bold";
  headerFour[i].style["margin"] = "0";
  headerFour[i].style["padding-left"] = "10px";
}
