...
// return all terms from the terms file
app.get('/api/terms/', (req, res) => {
  // TODO: Add a comment describing the req.query object
  // req.query contains an object made up of all the query parameters
...
// if there’s a match, return the term. if not match, "No term found".
app.get('/api/term/:term', (req, res) => {
  // TODO: Add a comment describing the content of req.params in this instance
  // whatever gets passed in the call. the key is "term"
...
// TODO: Add a comment describing what this route will return
// Returns all terms with the matching category passed by the call.
...
// TODO: Add a comment describing what this route will return
// Returns a list of all categories (and nothing else)
