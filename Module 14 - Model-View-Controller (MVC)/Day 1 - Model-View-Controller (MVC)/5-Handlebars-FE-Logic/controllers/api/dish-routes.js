...
// Controller. It takes input (ID, and new values for fields) and does soemthing with it (updates the item in the db).
router.put('/:id', async (req, res) => {
  // TODO: Where is this action method sending the data from the body of the fetch request? Why?
  // To the Dish Model (database), to update the data.
  try {
    ...
    // New values returned and displayed (in the View).
